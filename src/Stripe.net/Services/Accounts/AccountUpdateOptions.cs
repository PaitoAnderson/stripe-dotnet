namespace Stripe
{
    ...
    public class AccountUpdateOptions : BaseOptions, IHasMetadata
    {
        ...
        /// <summary>
        /// Email address of the account representative. For Standard accounts, this is used to ask
        /// them to claim their Stripe account. For Custom accounts, this only makes the account
        /// easier to identify to platforms; Stripe does not email the account representative.
        /// </summary>
        [JsonProperty("email")]
