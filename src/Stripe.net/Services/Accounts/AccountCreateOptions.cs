namespace Stripe
{
    ...
    public class AccountCreateOptions : BaseOptions, IHasMetadata
    {
        ...
        /// <summary>
        /// The type of Stripe account to create. Currently must be <c>custom</c>, as only <a
        /// href="https://stripe.com/docs/connect/custom-accounts">Custom accounts</a> may be
        /// created via the API.
        /// </summary>
        [JsonProperty("type")]
